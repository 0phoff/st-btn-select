...
st.set_page_config(
    ...
    page_icon='https://raw.githubusercontent.com/0phoff/st-btn-select/master/public/favicon.png',
)
...
if page == 'home':
    st.image(
        'https://raw.githubusercontent.com/0phoff/st-btn-select/master/public/logo.svg',
